...
# WARNING: add a version variable
echo "#SBATCH -J $JOB_ID.v1.protenix" >> /storage/gaoyiqinLab/wangpeixin/work/protenix_sh_scripts/protenix_job_${TYPE_ID}_${JOB_ID}.sh
echo "#SBATCH --nodes=1" >> /storage/gaoyiqinLab/wangpeixin/work/protenix_sh_scripts/protenix_job_${TYPE_ID}_${JOB_ID}.sh
